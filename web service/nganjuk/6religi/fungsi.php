...
function tambah($data) {
	...
	//query insert data
	$query ="INSERT INTO religi VALUES ('','$nama','$lokasi','$isi','$gambar','$kategori') ";
...
function hapus ($id) {
	...
	mysqli_query($conn, "DELETE FROM religi WHERE id=$id");
...
function cari ($keyword) {
	$query = "SELECT * FROM religi WHERE nama
	 		LIKE '%$keyword%'
