...
function tambah($data) {
	...
	//query insert data
	$query ="INSERT INTO alam VALUES ('','$nama','$lokasi','$isi','$gambar','$kategori') ";
...
function hapus ($id) {
	...
	mysqli_query($conn, "DELETE FROM alam WHERE id=$id");
...
function golek ($keyword) {
	$query = "SELECT * FROM alam WHERE nama
	 		LIKE '%$keyword%'
