...
public class AlamDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with(this).load("https://nganjukexplore.000webhostapp.com/1alam/img/" + gambar).apply(requestOptions).into(img);
