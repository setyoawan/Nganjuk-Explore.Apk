...
import com.example.SetyoAwanNganjukExplore.activities.ReligiDetail;
import com.example.SetyoAwanNganjukExplore.model.ModelReligi;

import java.util.List;

public class AdapterReligi extends RecyclerView.Adapter<RecyclerViewAdapter.MyViewHolder> {

    RequestOptions option ;
    private Context mContext ;
    private List<ModelReligi> mData ;


    public AdapterReligi(Context mContext, List<ModelReligi> mData) {
    ...
    public RecyclerViewAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        viewHolder.view_container.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(mContext, ReligiDetail.class);
    ...
    public void onBindViewHolder(RecyclerViewAdapter.MyViewHolder holder, int position) {
        ...
        Glide.with(mContext)
                .load("https://nganjukexplore.000webhostapp.com/6religi/img/"+ mData.get(position).getGambar())
