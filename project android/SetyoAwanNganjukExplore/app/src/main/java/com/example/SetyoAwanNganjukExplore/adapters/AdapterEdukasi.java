...
import com.example.SetyoAwanNganjukExplore.activities.EdukasiDetail;
import com.example.SetyoAwanNganjukExplore.model.ModelEdukasi;

import java.util.List;

public class AdapterEdukasi extends RecyclerView.Adapter<RecyclerViewAdapter.MyViewHolder> {


    RequestOptions option ;
    private Context mContext ;
    private List<ModelEdukasi> mData ;


    public AdapterEdukasi (Context mContext, List<ModelEdukasi> mData) {
    ...
    public RecyclerViewAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        viewHolder.view_container.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(mContext, EdukasiDetail.class);
    ...
    public void onBindViewHolder(RecyclerViewAdapter.MyViewHolder holder, int position) {
        ...
        Glide.with(mContext)
                .load("https://nganjukexplore.000webhostapp.com/3edukasi/img/"+ mData.get(position).getGambar())
