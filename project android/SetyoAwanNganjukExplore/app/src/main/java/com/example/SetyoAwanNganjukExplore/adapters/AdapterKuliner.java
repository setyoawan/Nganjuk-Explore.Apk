...
import com.example.SetyoAwanNganjukExplore.activities.KulinerDetail;
import com.example.SetyoAwanNganjukExplore.model.ModelKuliner;

import java.util.List;

public class AdapterKuliner extends RecyclerView.Adapter<RecyclerViewAdapter.MyViewHolder> {

    RequestOptions option ;
    private Context mContext ;
    private List<ModelKuliner> mData ;


    public AdapterKuliner (Context mContext, List<ModelKuliner> mData) {
    ...
    public RecyclerViewAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        viewHolder.view_container.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(mContext, KulinerDetail.class);
    ...
    public void onBindViewHolder(RecyclerViewAdapter.MyViewHolder holder, int position) {
        ...
        Glide.with(mContext)
                .load("https://nganjukexplore.000webhostapp.com/4kuliner/img/"+ mData.get(position).getGambar())
