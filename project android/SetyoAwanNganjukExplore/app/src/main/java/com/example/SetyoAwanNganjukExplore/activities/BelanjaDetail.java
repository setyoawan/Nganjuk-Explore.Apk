...
public class BelanjaDetail extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_belanja_detail);
        ...
        Glide.with(this).load("https://nganjukexplore.000webhostapp.com/5belanja/img/" + gambar).apply(requestOptions).into(img);
