...
import com.example.SetyoAwanNganjukExplore.activities.AlamDetail;
...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.MyViewHolder> {
    ...
    private List<ModelAlam> mData ;

    public RecyclerViewAdapter(Context mContext, List<ModelAlam> mData) {
    ...
    public MyViewHolder onCreateViewHolder( ViewGroup parent, int viewType) {
        ...
        viewHolder.view_container.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(mContext, AlamDetail.class);
    ...
    public void onBindViewHolder( MyViewHolder holder, int position) {
        ...
        Glide.with(mContext)
                .load("https://nganjukexplore.000webhostapp.com/1alam/img/"+ mData.get(position).getGambar())
