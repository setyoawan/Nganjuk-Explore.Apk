...
import com.example.SetyoAwanNganjukExplore.activities.SejarahDetail;
import com.example.SetyoAwanNganjukExplore.model.ModelSejarah;

import java.util.List;

public class AdapterSejarah extends RecyclerView.Adapter<RecyclerViewAdapter.MyViewHolder> {


    RequestOptions option ;
    private Context mContext ;
    private List<ModelSejarah> mData ;


    public AdapterSejarah (Context mContext, List<ModelSejarah> mData) {
    ...
    public RecyclerViewAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        viewHolder.view_container.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(mContext, SejarahDetail.class);
    ...
    public void onBindViewHolder(RecyclerViewAdapter.MyViewHolder holder, int position) {
        ...
        Glide.with(mContext)
                .load("https://nganjukexplore.000webhostapp.com/2sejarah/img"+ mData.get(position).getGambar())
