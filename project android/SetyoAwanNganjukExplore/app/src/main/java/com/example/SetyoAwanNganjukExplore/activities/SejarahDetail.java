...
public class SejarahDetail extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sejarah_detail);
        ...
        Glide.with(this).load("https://nganjukexplore.000webhostapp.com/2sejarah/img/" + gambar).apply(requestOptions).into(img);
