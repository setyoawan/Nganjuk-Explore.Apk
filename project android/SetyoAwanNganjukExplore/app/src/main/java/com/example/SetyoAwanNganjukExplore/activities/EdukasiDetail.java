...
public class EdukasiDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with(this).load("https://nganjukexplore.000webhostapp.com/3edukasi/img/" + gambar).apply(requestOptions).into(img);
